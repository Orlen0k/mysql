DROP DATABASE IF EXISTS netflix_serials;
CREATE DATABASE netflix_serials;
USE netflix_serials;
...
CREATE TABLE studios (
	...
	studio VARCHAR(200) UNIQUE NOT NULL
);
...
-- Функция расчета актулаьнсти жанра 
...
-- ----------------------------------- Функция подсчета актуальности ключевых слов
